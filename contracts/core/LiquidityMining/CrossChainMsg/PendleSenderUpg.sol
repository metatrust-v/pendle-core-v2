...
import "../../../interfaces/IPSendEndpoint.sol";
...
abstract contract PendleSenderUpg is BoringOwnableUpgradeable {
    using EnumerableMap for EnumerableMap.UintToAddressMap;

    IPSendEndpoint public immutable pendleMsgSendEndpoint;
    ...
    constructor(address _pendleMsgSendEndpoint) {
        pendleMsgSendEndpoint = IPSendEndpoint(_pendleMsgSendEndpoint);
    }
