...
/**
 * @title Benqi's QiErc20 Contract
 * @notice QiTokens which wrap an EIP-20 underlying
 * @author Benqi
 */
contract QiErc20 is QiToken, QiErc20Interface {
    /**
    ...
    function initialize(
        ...
        // QiToken initialize does the bulk of the work
        super.initialize(
            comptroller_,
            interestRateModel_,
    ...
    function liquidateBorrow(
        ...
        (uint256 err, ) = liquidateBorrowInternal(borrower, repayAmount, qiTokenCollateral);
        return err;
    }
    ...
    function sweepToken(EIP20NonStandardInterface token) external override {
        require(
            ...
            "QiErc20::sweepToken: can not sweep underlying token"
        );
