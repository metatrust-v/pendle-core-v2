...
contract QiAvax is QiToken {
     ...
     */
    function liquidateBorrow(address borrower, QiToken qiTokenCollateral) external payable {
        (uint256 err, ) = liquidateBorrowInternal(borrower, msg.value, qiTokenCollateral);
