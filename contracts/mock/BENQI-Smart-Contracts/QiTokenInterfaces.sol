...
contract QiTokenStorage {
    ...
    /**
     * @notice Contract which oversees inter-qiToken operations
     */
    ...
    /**
     * @notice Initial exchange rate used when minting the first QiTokens (used when totalSupply = 0)
     */
...
abstract contract QiTokenInterface is QiTokenStorage {
    /**
     * @notice Indicator that this is a QiToken contract (for inspection)
     */
...
contract QiErc20Storage {
    /**
     * @notice Underlying asset for this QiToken
     */
    address public underlying;
}

abstract contract QiErc20Interface is QiErc20Storage {
    /*** User Interface ***/
...
abstract contract QiDelegatorInterface is QiDelegationStorage {
    /**
...
abstract contract QiDelegateInterface is QiDelegationStorage {
    /**
