...
contract Qi {
    ...
    function permit(
        ...
        require(block.timestamp <= deadline, "Qi::permit: signature expired");
    ...
    function transferFrom(
        ...
        if (spender != src && spenderAllowance != type(uint96).max) {
            uint96 newAllowance = sub96(
                spenderAllowance,
                amount,
                "Qi::transferFrom: transfer amount exceeds spender allowance"
            );
    ...
    function delegateBySig(
        ...
        require(block.timestamp <= expiry, "Qi::delegateBySig: signature expired");
    ...
    function _transferTokens(
        ...
        balances[src] = sub96(
            balances[src],
            amount,
            "Qi::_transferTokens: transfer amount exceeds balance"
        );
        balances[dst] = add96(
            balances[dst],
            amount,
            "Qi::_transferTokens: transfer amount overflows"
        );
        ...
        if (srcRep != dstRep && amount > 0) {
            if (srcRep != address(0)) {
                ...
                uint96 srcRepNew = sub96(
                    srcRepOld,
                    amount,
                    "Qi::_moveVotes: vote amount underflows"
                );
            ...
            if (dstRep != address(0)) {
                ...
                uint96 dstRepNew = add96(
                    dstRepOld,
                    amount,
                    "Qi::_moveVotes: vote amount overflows"
                );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "Qi::_writeCheckpoint: block number exceeds 32 bits"
        );
