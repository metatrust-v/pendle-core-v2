...
library Errors {
    ...
    error MarketInsufficientPtBal(uint256 actualBalance, uint256 requiredBalance);
    error MarketInsufficientScyBal(uint256 actualBalance, uint256 requiredBalance);
